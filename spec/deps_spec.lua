...
describe("LuaRocks deps tests #blackbox #b_deps", function()
   ...
   it("LuaRocks deps mode one", function()
      ...
      assert.is_true(run.luarocks_bool("build --deps-mode=one --tree=" .. testing_paths.testing_user_tree .. " lxsh"))
   ...
   it("LuaRocks deps mode order", function()
      assert.is_true(run.luarocks_bool("build --tree=system lpeg"))
      assert.is_true(run.luarocks_bool("build --deps-mode=order --tree=" .. testing_paths.testing_user_tree .. " lxsh"))
   ...
   it("LuaRocks deps mode order sys", function()
      assert.is_true(run.luarocks_bool("build --tree=" .. testing_paths.testing_user_tree .. " lpeg"))
      assert.is_true(run.luarocks_bool("build --deps-mode=order --tree=" .. testing_paths.testing_system_tree .. " lxsh"))
   ...
   it("LuaRocks deps mode all sys", function()
      assert.is_true(run.luarocks_bool("build --tree=" .. testing_paths.testing_user_tree .. " lpeg"))
      assert.is_true(run.luarocks_bool("build --deps-mode=all --tree=" .. testing_paths.testing_system_tree .. " lxsh"))
   ...
   it("LuaRocks nodeps alias", function()
      assert.is_true(run.luarocks_bool("build --tree=" .. testing_paths.testing_user_tree .. " --nodeps lxsh"))
   ...
   it("LuaRocks deps mode make order", function()
      assert.is_true(run.luarocks_bool("build --tree=" .. testing_paths.testing_system_tree .. " lpeg"))
      ...
      assert.is_true(run.luarocks_bool("make --tree=" .. testing_paths.testing_user_tree .. " --deps-mode=order"))
   ...
   it("LuaRocks deps mode make order sys", function()
      ...
      assert.is_true(run.luarocks_bool("unpack lxsh-0.8.6-2.src.rock"))
      lfs.chdir("lxsh-0.8.6-2/lxsh-0.8.6-1/")
      assert.is_true(run.luarocks_bool("make --tree=" .. testing_paths.testing_system_tree .. " --deps-mode=order"))
