...
local loaders = package.loaders or package.searchers -- luacheck: ignore
...
if luarocks then -- luacheck: ignore
   ...
   luarocks.loader = loader -- luacheck: ignore
else
   ...
   if info.what == "C" and not info.name then
      luarocks = { loader = loader } -- luacheck: ignore 111
...
function loader.add_context(name, version)
   ...
   if temporary_global then
      ...
      luarocks = nil -- luacheck: ignore 111
